 ...
 */
const multiSelectVariants = cva('m-1 transition ease-in-out delay-150 duration-300 rounded', {
  variants: {
    variant: {
      default: 'text-foreground bg-bg-default hover:bg-bg-default/80 border-none bg-red',
      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
        <PopoverTrigger asChild className="border-stroke-default">
          <Button
            ...
            className={cn(
              'flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit border-stroke-default',
              className,
            )}
          >
