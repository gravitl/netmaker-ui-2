...
export function getHostHealth(
  ...
  switch (worstHealth) {
    default:
      return shouldRender ? <NodeStatus nodeHealth="unknown" /> : 'unknown';
    case 1:
      return shouldRender ? <NodeStatus nodeHealth="error" /> : 'error';
    case 2:
      return shouldRender ? <NodeStatus nodeHealth="warning" /> : 'warning';
    case 3:
